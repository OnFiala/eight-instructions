...
Celá lokální sada prošla 74/74, bez přeskočených testů, v 578 980,073 ms. Původních 50 regresních testů zůstalo. Test 450 cyklů přeložil souhrnně 9 000 slov, překročil původních 8 192 slov i 256 položek, používal stále šest arén a skončil se 40 živými slovy ve dvou verzích; po odstranění nezůstala žádná živá verze. V tomto izolovaném testu s core + workspace měl rezidentní kód 7 078 slov a slovník 162 položek; během cyklů nerostly. Nejde o velikost celé městské aplikace. Tento poslední zátěžový běh trval 457 751,376 ms, nebyl izolovaným benchmarkem. Viz final-local-tests.txt.
